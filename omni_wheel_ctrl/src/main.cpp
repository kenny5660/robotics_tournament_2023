...
void M2(int cps1_des, int dir1);
void M3(int cps1_des, int dir1);
...
void setup() {
  ...
  attachInterrupt(digitalPinToInterrupt(encoder1PinA), doEncoder1, CHANGE);  // encoder pin on interrupt 2

  pinMode(encoder2PinA, INPUT);
  digitalWrite(encoder2PinA, HIGH);
  pinMode(encoder2PinB, INPUT);
  digitalWrite(encoder2PinB, HIGH);
  attachInterrupt(digitalPinToInterrupt(encoder2PinA), doEncoder2, CHANGE);  // encoder pin on interrupt 18

  pinMode(encoder3PinA, INPUT);
  digitalWrite(encoder3PinA, HIGH);
  pinMode(encoder3PinB, INPUT);
  digitalWrite(encoder3PinB, HIGH);
  attachInterrupt(digitalPinToInterrupt(encoder3PinA), doEncoder3, CHANGE);  // encoder pin on interrupt 18
...
//=============== Timer ISR ======================================
void timer_handler(){                   // Speed calcullation
